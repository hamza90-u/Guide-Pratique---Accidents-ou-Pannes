...
const accidentSteps = [
  { icon: ParkingCircle, text: "Stationnez sur le côté ou idéalement sur la bande d'arrêt d'urgence sur l'autoroute." },
  { icon: TriangleAlert, text: "Sécuriser les lieux : Allumez les feux de détresse et placez le triangle de signalisation (à ~30m en ville et 100m ou 200m sur autoroute)." },
  { icon: Shirt, text: "Se mettre en sécurité : Portez votre gilet de haute visibilité. Faites sortir tous les passagers par les portes de droite et mettez-vous à l'abri derrière la barrière de sécurité." },
  ...
  { icon: Contact, text: <>Remplir le constat amiable : Échangez les informations avec le service FM par e-mail ou par téléphone. Envoyez les originaux au service FM, et ce <strong className="font-bold text-destructive">avant 24h max</strong> après la date du sinistre.</> },
