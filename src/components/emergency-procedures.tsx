...
const accidentSteps = [
  ...
  { icon: Contact, text: <>Remplir le constat amiable : Envoyez les originaux au service FM, et ce <strong className="font-bold text-destructive">avant 24h</strong> après la date du sinistre.</> },
